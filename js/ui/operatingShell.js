(function () {
    ...
    function getCommands() {
        return [
            ...
            command('workspace-new', 'New graph workspace', 'Workspace', () => callGlobal('createAnalystWorkspace')),
            command('workspace-next', 'Next graph workspace', 'Workspace', () => callGlobal('cycleAnalystWorkspace', 1)),
            command('workspace-prev', 'Previous graph workspace', 'Workspace', () => callGlobal('cycleAnalystWorkspace', -1)),
            command('snapshot-current', 'Snapshot investigation', 'Workspace', () => callGlobal('captureCurrentGraphSnapshot')),
            command('stage-current', 'Stage investigation', 'Workspace', () => callGlobal('queueCurrentInvestigation')),
            command('topology-summary', 'Topology summary', 'Topology', () => callGlobal('showTopologySummary')),
            command('topology-centrality', 'Jump market-central hub', 'Topology', () => callGlobal('jumpToMarketCentralHub')),
            command('topology-corridor-pressure', 'Jump pressure corridor', 'Topology', () => callGlobal('jumpToPressureCorridor')),
            ...
            command('route-stack-pin', 'Pin route to workspace stack', 'Route Stack', () => callGlobal('pinCurrentRoute'), { disabledReason: () => stockDisabledReason('route-step') }),
            ...
            command('stock-chronology-next', 'Next graph chronology event', 'Chronology', () => callGlobal('stepGraphChronology', 1)),
            command('stock-chronology-prev', 'Previous graph chronology event', 'Chronology', () => callGlobal('stepGraphChronology', -1)),
