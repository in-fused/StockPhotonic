...
def build_normalized_cache_metadata(payload: dict[str, Any], wallet: str, row_count: int, summary: dict[str, Any]) -> dict[str, Any]:
    ...
    rate_limited = bool(pick_cache_value(payload, "rate_limited", default=False))
    provider_limited = bool(pick_cache_value(payload, "provider_limited", "provider_limit_reached", default=False))
    provider_unavailable = bool(pick_cache_value(payload, "provider_unavailable", default=False))
    full_history_loaded = bool(pick_cache_value(payload, "full_history_loaded", default=False))
    full_history_claim_allowed = bool(
        pick_cache_value(payload, "full_history_claim_allowed", default=False)
        and cursor_exhausted
        and not more_available
    ...
    return {
        ...
        "provider_label": pick_cache_value(payload, "provider_label", default=pick_cache_value(payload, "provider", default="none")),
        "chain": pick_cache_value(payload, "chain", default="solana"),
        "wallet": wallet,
        "fetched_at": pick_cache_value(payload, "fetched_at", "generated_at", default=""),
        "cache_id": pick_cache_value(payload, "cache_id", default=""),
        "cache_version": pick_cache_value(payload, "cache_version", "cache_schema", default="d349_normalized_cache_metadata_v1"),
        "cache_schema": "d349_normalized_cache_metadata_v1",
        "cache_state": pick_cache_value(payload, "cache_state", default="normalized"),
        "cache_origin": pick_cache_value(payload, "cache_origin", default="provider_fetched" if pick_cache_value(payload, "provider_cache", "provider_fetched", default=False) else "local_normalized"),
        "cache_class": pick_cache_value(payload, "cache_class", default="provider_cache" if pick_cache_value(payload, "provider_cache", "provider_fetched", default=False) else "local_normalized"),
        "cache_artifact_class": pick_cache_value(payload, "cache_artifact_class", default="provider_cache" if pick_cache_value(payload, "provider_cache", "provider_fetched", default=False) else "local_normalized"),
        "provider_cache": bool(pick_cache_value(payload, "provider_cache", default=False)),
        "provider_cache_derived": bool(pick_cache_value(payload, "provider_cache_derived", default=False)),
        "provider_fetched": bool(pick_cache_value(payload, "provider_fetched", "provider_request_sent", default=False)),
        "source": pick_cache_value(payload, "source", default="local_normalizer"),
        "pages_loaded": pick_cache_value(payload, "pages_loaded", default=0),
        "pages_requested": pick_cache_value(payload, "pages_requested", default=0),
        "request_limit": pick_cache_value(payload, "request_limit", default=0),
        ...
        "backoff_applied_seconds": pick_cache_value(payload, "backoff_applied_seconds", default=0),
        "provider_limited": provider_limited,
        "provider_limit_reached": provider_limited,
        "limited_by_provider": provider_limited,
        "provider_unavailable": provider_unavailable,
        "full_history_loaded": full_history_loaded and full_history_claim_allowed,
        "full_history_claim_allowed": full_history_claim_allowed,
        "stop_reason": pick_cache_value(payload, "stop_reason", default=""),
        "page_summaries": as_list(pick_cache_value(payload, "page_summaries", default=[])),
        "raw_payload_stored": False,
...
def build_output(payload: dict[str, Any], rows: list[dict[str, Any]], input_path: Path) -> dict[str, Any]:
    ...
    return {
        "metadata": {
            ...
            "version": "d349_normalized_transactions_v1",
            ...
            "raw_provider_payloads_included": False,
            "wallet": wallet,
            "provider": normalized_cache_metadata.get("provider"),
            "provider_label": normalized_cache_metadata.get("provider_label"),
            "cache_id": normalized_cache_metadata.get("cache_id"),
            "cache_version": normalized_cache_metadata.get("cache_version"),
            "provider_cache": normalized_cache_metadata.get("provider_cache", False),
            "provider_cache_derived": normalized_cache_metadata.get("provider_cache_derived", False),
            "provider_fetched": normalized_cache_metadata.get("provider_fetched", False),
            "cache_origin": normalized_cache_metadata.get("cache_origin"),
            "cache_class": normalized_cache_metadata.get("cache_class"),
            "cache_artifact_class": normalized_cache_metadata.get("cache_artifact_class"),
            "sanitized": True,
...
def build_replay_cache(normalized: dict[str, Any], source_file: Path) -> dict[str, Any]:
    ...
    return {
        "metadata": {
            ...
            "provider_cache_id": cache_metadata.get("cache_id"),
            "provider_cache_version": cache_metadata.get("cache_version"),
            "provider_cache": cache_metadata.get("provider_cache", False),
            "provider_cache_derived": cache_metadata.get("provider_cache_derived", False),
            "provider_fetched": cache_metadata.get("provider_fetched", False),
            "cache_origin": cache_metadata.get("cache_origin"),
            "cache_class": cache_metadata.get("cache_class"),
            "cache_artifact_class": cache_metadata.get("cache_artifact_class"),
            "sanitized": True,
        ...
        "cache": {
            ...
            "provider_cache_id": cache_metadata.get("cache_id"),
            "provider_cache_version": cache_metadata.get("cache_version"),
            "cache_schema": "d349_replay_cache_v1",
            ...
            "pages_requested": cache_metadata.get("pages_requested", 0),
            "request_limit": cache_metadata.get("request_limit", 0),
            ...
            "full_history_claim_allowed": cache_metadata.get("full_history_claim_allowed", False),
            "rate_limited": cache_metadata.get("rate_limited", False),
            "retry_after_seconds": cache_metadata.get("retry_after_seconds"),
            "cooldown_applied_seconds": cache_metadata.get("cooldown_applied_seconds", 0),
            "backoff_applied_seconds": cache_metadata.get("backoff_applied_seconds", 0),
            "provider_limited": cache_metadata.get("provider_limited", False),
            "provider_limit_reached": cache_metadata.get("provider_limit_reached", cache_metadata.get("provider_limited", False)),
            "limited_by_provider": cache_metadata.get("limited_by_provider", cache_metadata.get("provider_limited", False)),
            "provider_unavailable": cache_metadata.get("provider_unavailable", False),
            "stop_reason": cache_metadata.get("stop_reason", ""),
            "page_summaries": as_list(cache_metadata.get("page_summaries")),
            "raw_payload_stored": False,
