(function () {
    ...
    function renderActiveContextStrip(context) {
        ...
        const filters = [
            ...
            context.candidateCompanyPreviewOnlyFilter ? 'Candidate companies' : '',
            context.candidateCompanyStrategicHubOnlyFilter ? 'Candidate hubs' : '',
            context.candidateCompanyEcosystemFocus ? `Candidate ecosystem: ${context.candidateCompanyEcosystemFocus}` : '',
            context.candidateCompanyCorridorFocus ? `Candidate corridor: ${context.candidateCompanyCorridorFocus}` : '',
