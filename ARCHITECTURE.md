...
- Source Workbench pipeline: Static UI tab documenting local SEC commands, candidate files, workflow stages, candidate preview status, generated triage/overlap artifacts, source coverage refresh state, OpenAlex context artifacts, corridor lanes, and graph growth metrics when present.
